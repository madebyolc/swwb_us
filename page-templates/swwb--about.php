      ...
      <div class="panel-inner">
          ...
          <div class="container typr theme <?php if ( is_singular() && get_post_meta($post->ID, 'section-3-theme', true) ) : echo get_post_meta($post->ID, 'section-3-theme', true); endif; ?>">
            ...
            <div class="container-wrapper-100">
              ...
              <div id="section-3-description-wrapper typr">

                <p id="section-3-intro" class="lead col-sm-9 offset-sm-3 np">

                  <?php if ( get_post_meta($post->ID, 'section-3-intro', true) ) : echo get_post_meta($post->ID, 'section-3-intro', true); endif; ?>

                </p>

                <div class="col-sm-9 offset-sm-3 np">
          ...
          <div class="container typr theme <?php if ( is_singular() && get_post_meta($post->ID, 'section-4-theme', true) ) : echo get_post_meta($post->ID, 'section-4-theme', true); endif; ?>">
            ...
            <div class="container-wrapper-100">
              ...
              <div id="section-4-description-wrapper typr">
                ...
                <p id="section-4-intro" class="lead col-sm-9 np">
                ...
                <div class="panel-row row">
                  ...
                  <div class="panel-boxes col-sm-6">
                    ...
                    <div class="panel-box">
                      ...
                      <?php if ( get_post_meta($post->ID, 'section-5-objective-1-img', true) ) : echo get_post_meta($post->ID, 'section-5-objective-1-img', true); endif; ?>
                ...
                <div class="panel-row row">
                  ...
                  <div class="panel-boxes col-sm-6">
                    ...
                    <div class="panel-box">
                      ...
                      <?php if ( get_post_meta($post->ID, 'section-5-objective-2-img', true) ) : echo get_post_meta($post->ID, 'section-5-objective-2-img', true); endif; ?>
                ...
                <div class="panel-row row">
                  ...
                  <div class="panel-boxes col-sm-6">
                    ...
                    <div class="panel-box">
                      ...
                      <?php if ( get_post_meta($post->ID, 'section-5-objective-3-img', true) ) : echo get_post_meta($post->ID, 'section-5-objective-3-img', true); endif; ?>
                ...
                <div class="panel-row row">
                  ...
                  <div class="panel-boxes col-sm-6">
                    ...
                    <div class="panel-box">
                      ...
                      <?php if ( get_post_meta($post->ID, 'section-5-objective-4-img', true) ) : echo get_post_meta($post->ID, 'section-5-objective-4-img', true); endif; ?>
                ...
                <div class="panel-row row">
                  ...
                  <div class="panel-boxes col-sm-6">
                    ...
                    <div class="panel-box">
                      ...
                      <?php if ( get_post_meta($post->ID, 'section-5-objective-5-img', true) ) : echo get_post_meta($post->ID, 'section-5-objective-5-img', true); endif; ?>
          ...
          <div class="container typr theme <?php if ( is_singular() && get_post_meta($post->ID, 'section-6-theme', true) ) : echo get_post_meta($post->ID, 'section-6-theme', true); endif; ?>">
            ...
            <div class="container-wrapper-100">
              ...
              <div id="section-6-description-wrapper typr">
                ...
                <h2 id="section-6-intro" class="col-sm-12 np">
          ...
          <div class="container typr theme <?php if ( is_singular() && get_post_meta($post->ID, 'section-7-theme', true) ) : echo get_post_meta($post->ID, 'section-7-theme', true); endif; ?>">
            ...
            <div class="container-wrapper-100">
              ...
              <div id="section-7-description-wrapper typr">
                ...
                <div class="panel-row row">
                  ...
                  <div class="panel-boxes col-sm-12">
                    ...
                    <div class="panel-box typr">
                      ...
                      <p>The SWWB team</p>
                      <a href="<?php echo get_category_link( 3 ); ?> " class="btn btn-tertiary btn-lg go forward clear typr" role="button" aria-pressed="true">Latest News</a>
                      <span class="typr lighten">&nbsp;Updates from our National Network</span>
                ...
                <a href="#" class="btn btn-plain btn-lg go top np clear typr" role="button" aria-pressed="true">To the Top</a>

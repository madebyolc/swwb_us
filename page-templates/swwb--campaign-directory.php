...
/**
 * Project name: SWWB
 * Template name: Campaign Directory
 * @package understrap
 */
                ...
                <div class="col-xs-4 np right">
                  ...
                  <h2 class="lighten b" >
                    ...
                    <small>
                      ...
                      <span class="hidden-sm-down">Launched</span> <?php echo get_the_date('M Y'); ?>
                      <button class="btn btn-none" title="Link to this point" data-clipboard-text="<?php echo get_permalink( $post->post_parent ); ?>#<?php echo sanitize_title_with_dashes( get_the_title()); ?>"><i class="fa fa-link" aria-hidden="true"></i></button>
